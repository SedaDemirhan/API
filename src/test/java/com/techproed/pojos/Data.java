...
public class Data {
     ...
     */
    public Data(Integer id, String employee_name, Integer employee_salary, Integer employee_age, String profile_ımage) {
        super();
        this.id = id;
        this.employee_name = employee_name;
        this.employee_salary = employee_salary;
        this.employee_age = employee_age;
        this.profile_ımage = profile_ımage;
    }
    ...
    public String getprofile_ımage() {
        return profile_ımage;
    }

    public void setprofile_ımage(String profile_ımage) {
        this.profile_ımage = profile_ımage;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("profile_ımage");
        sb.append('=');
        sb.append(((this.profile_ımage == null)?"<null>":this.profile_ımage));
        sb.append(',');
