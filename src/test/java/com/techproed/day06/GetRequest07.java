...
public class GetRequest07 extends HerokuAppTestBase {
    ...
    public void test01(){
       ...
       // Assert.assertEquals(200,response.getStatusCode()); bu yöntemle de alabiliriz
        //status code ve content type json path ile alamıyoruz.O nedenle matcher ile yaptık
        ...
        Assert.assertEquals("2017-12-11",jsonPath.getString("bookingdates,checkin"));
        Assert.assertEquals("2020-02-20",jsonPath.getString("bookingdates,checkout"));
    }
