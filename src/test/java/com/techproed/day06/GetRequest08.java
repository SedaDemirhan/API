...
public class GetRequest08 extends DummyTestBase {
    ...
    public void test(){
       ...
       // System.out.println(jsonPath.getString("data.employee_name")); bu yöntem de list gibi aynı sonucu verir
        System.out.println(jsonPath.getString("data[2].employee_name"));
       // System.out.println(jsonPath.getString("data.employee_name[2]"));bu da aynı şeyi verir
